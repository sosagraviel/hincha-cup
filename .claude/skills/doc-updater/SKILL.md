...
```json
{
  "todos": [
    {
      "content": "Read current CLAUDE.md and the three convention skills",
      "status": "in_progress",
...
1. Use the Edit tool to apply changes to the appropriate skill body:
   ...
   ```
   Edit({
     file_path: '.claude/skills/code-conventions/SKILL.md',
     old_string: update.before,
     new_string: update.after,
   })
   ```
   ...
   ```
   Edit({
     file_path: '.claude/skills/multi-file-workflows/SKILL.md',
     old_string: update.before,
     new_string: update.after,
   })
   ```
   ...
   ```
   Edit({
     file_path: '.claude/skills/testing-conventions/SKILL.md',
     old_string: update.before,
     new_string: update.after,
   })
   ```
...
skill. Invoke `/wiki-refresh` instead — the wiki-generator re-runs over
...
- Documentation remains within line bounds (CLAUDE.md 30–250 lines; code-conventions 30–250; multi-file-workflows 20–200; testing-conventions 25–200)
...
This skill is invoked from `implement-ticket` Phase 8:
