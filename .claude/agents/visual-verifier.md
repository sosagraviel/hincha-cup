...
- **JIRA Ticket**: 
- **Project**: 
- **Diff Report**: `.claude-temp/tickets//artifacts/screenshots/diffs/visual-diff-report.json`
- **Changed Files**: 
- **Visual Mode**: 
- **Diff Threshold**: %
- **Expected Images**: 
...
```bash
cat .claude-temp/tickets//artifacts/screenshots/diffs/visual-diff-report.json
```
...
```bash
ls -la .claude-temp/tickets//artifacts/screenshots/diffs/
```
...
```
.claude-temp/tickets//artifacts/visual-verification-analysis.json
```
