...
1. `npm run emulators` — esperar a que los emuladores estén listos
2. `npm run seed:emulator`
3. `npm run dev`
4. Abrir `http://localhost:5173`

Si los emuladores fallan al iniciar (puertos ocupados):

```bash
lsof -tiTCP:8080,8081,9099,9199,4400,4500 -sTCP:LISTEN | xargs kill -9
```

Luego repetir desde el paso 1.
