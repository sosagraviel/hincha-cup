...
```bash
cd ai-agentic-framework/docker/claude-runtime
cp .env.example .env
```
...
```
ai-agentic-framework/docker/claude-runtime/
...
```yaml
# ai-agentic-framework/docker/multi-project.yml
version: '3.9'
...
Then:
```bash
docker-compose -f ai-agentic-framework/docker/multi-project.yml up -d
