...
chmod 755 ai-agentic-framework/utils/*.sh

# Directories should be 755
chmod 755 ai-agentic-framework/
```
...
- [ ] Run security check: `./ai-agentic-framework/utils/security-check.sh`
...
semgrep --config=auto ai-agentic-framework/
```
