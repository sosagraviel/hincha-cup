...
```javascript
const { analyzeRisk, selectStrategy } = require('./utils/select-strategy.js');
...
```javascript
const { generatePlan, calculateConfidence } = require('./utils/auto-plan.js');
...
```javascript
const { makeDecision, logDecision } = require('./utils/autonomous-decision.js');
...
```javascript
const { logAssumption, getAssumptions } = require('./utils/log-assumption.js');
...
```javascript
const { selectTests, buildDependencyGraph } = require('./utils/smart-test-selection.js');
...
```javascript
const { healTests, detectFailurePattern } = require('./utils/self-healing-tests.js');
...
```javascript
const { handleError, classifyError, suggestFix } = require('./utils/error-handler.js');
...
```javascript
const { retryWithBackoff } = require('./utils/retry-with-backoff.js');
...
```javascript
const { detectDocumentationNeeds } = require('./utils/detect-doc-updates.js');
...
```javascript
const { calculateAccuracy } = require('./utils/calculate-accuracy.js');
...
```javascript
const { analyzeRisk } = require('./utils/select-strategy.js');
const { generatePlan } = require('./utils/auto-plan.js');
const { selectTests } = require('./utils/smart-test-selection.js');
const { healTests } = require('./utils/self-healing-tests.js');
const { logAssumption } = require('./utils/log-assumption.js');
