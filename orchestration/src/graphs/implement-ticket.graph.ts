...
import { ImplementTicketAnnotation, type ImplementTicketState } from '../state/schemas/implement-ticket.schema.js';
...
/**
 * Routing function for conditional exit based on current_phase
 *
 * This handles failed states and completion
 */
function routeAfterPhase(state: typeof ImplementTicketAnnotation.State): string {
  const currentPhase = state.current_phase;

  // If failed, go straight to cleanup (best effort)
