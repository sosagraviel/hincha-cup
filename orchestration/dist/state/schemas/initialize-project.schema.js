...
export const InitializeProjectAnnotation = Annotation.Root({
    ...
    // ============================================================================
    project_path: (Annotation),
    framework_path: (Annotation),
    // ============================================================================
    ...
    phase2_consolidation: (Annotation),
    phase3_synthesis: (Annotation),
    phase4_context: (Annotation),
    // ============================================================================
    ...
    phase1_retry_tracking: Annotation({
        reducer: (left, right) => ({ ...left, ...right }),
        default: () => ({})
    }),
    // Phases 2-4: Sequential nodes, use default LastValue reducer
    phase2_retry: (Annotation),
    phase3_retry: (Annotation),
    phase4_retry: (Annotation),
    // ============================================================================
    ...
    // ============================================================================
    framework_config_path: (Annotation),
    claude_md_path: (Annotation),
    project_context_path: (Annotation),
    // ============================================================================
    // METADATA (use default LastValue reducer)
    // ============================================================================
    started_at: (Annotation),
    completed_at: (Annotation),
    total_duration_ms: (Annotation),
    checkpoint_id: (Annotation)
});
//# sourceMappingURL=initialize-project.schema.js.map