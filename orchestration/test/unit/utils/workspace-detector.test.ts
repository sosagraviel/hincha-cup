  ...
  describe("detectWorkspaces", () => {
    ...
    it("should ignore node_modules directories", async () => {
      ...
      await writeFile(
        ...
        JSON.stringify({ name: "should-ignore" }),
      );
    ...
    it("should ignore build/dist directories", async () => {
      ...
      await writeFile(
        ...
        JSON.stringify({ name: "build-output" }),
      );
    ...
    it("should find workspaces within maxDepth", async () => {
      ...
      await writeFile(
        join(shallow, "package.json"),
        JSON.stringify({ name: "shallow" }),
      );
    ...
    it("should handle multiple Python manifest types", async () => {
      ...
      expect(
        manifestFiles.includes("requirements.txt") ||
          manifestFiles.includes("setup.py"),
      ).toBe(true);
    });
    ...
    it("should detect PHP workspace with composer.json", async () => {
      await writeFile(
        ...
        JSON.stringify({ name: "my-php-project" }),
      );
