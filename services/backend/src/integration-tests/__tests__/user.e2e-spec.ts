...
describe('User API (e2e)', () => {
  ...
  describe('PATCH /users/me', () => {
    it('should update current user fullName', async () => {
      ...
      const restore = await httpClient.patch(
        '/users/me',
        { fullName: 'Alice Johnson' },
        { headers: { Authorization: `Bearer ${aliceToken}` } }
      );
