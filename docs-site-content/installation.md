...
1. [Quickstart Guide](quickstart.md) - First automation
2. [Implement Ticket](workflows/implement-ticket.md) - Ticket to PR
3. [Create Ticket](workflows/create-sdd-ticket.md) - Idea to ticket
